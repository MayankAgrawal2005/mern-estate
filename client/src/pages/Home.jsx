...
export default function Home() {
  ...
  const [offerrListings,setOfferListings]=useState([]);
  const [saleListings,setSaleListings]=useState([]);
  const [rentListings,setRentListings]=useState([]);
  SwiperCore.use([Navigation]);
  console.log('offer listings',offerrListings);
...
return (
    <div>
     ...
     {/* top side */}
          ...
          <div className='flex flex-col gap-6 p-28 px-3 max-6xl mx-auto'>
          ...
          <div className='text-gray-400 text-xs sm:text-sm'>
            Mayank Estate is the best place to find your 
     ...
     {
      offerrListings && offerrListings.length>0 && 

      offerrListings.map((listing)=>(
        <SwiperSlide >
          <div 
          style={{
